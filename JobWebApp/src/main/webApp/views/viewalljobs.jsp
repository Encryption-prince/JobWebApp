...
<%@ page import="com.subham.JobWebApp.model.JobPost" %>
<%@ page import="com.subham.JobWebApp.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://sitechecker.pro/wp-content/uploads/2023/06/404-status-code.png">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
